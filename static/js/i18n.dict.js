...
window.SL_FR_DICT = {
  ...
  // ===================== command palette =====================
  "Type a table, snippet or action…": "Tapez une table, un snippet ou une action…",
  ...
  // "snippet" stays "snippet" in French — never translate it (e.g. not "extrait")
  "Snippets": "Snippets",
  "Saved snippets": "Snippets enregistrés",
  "Save current editor as snippet": "Enregistrer l'éditeur actuel comme snippet",
  "Save snippet": "Enregistrer le snippet",
  ...
  "My notebook": "Mon notebook",
  "Empty notebook — add a SQL or text cell below.": "Notebook vide — ajoutez une cellule SQL ou texte ci-dessous.",
  "Move up": "Monter",
  "Move down": "Descendre",
  "Delete cell": "Supprimer la cellule",
  "Text": "Texte",
  "Empty text cell — click to edit.": "Cellule de texte vide — cliquez pour modifier.",
  "{0} rows · {1} ms": "{0} lignes · {1} ms",
  "{0} row(s) affected · {1} ms": "{0} ligne(s) affectée(s) · {1} ms",
  "New notebook": "Nouveau notebook",
  "Name": "Nom",
  "Notebook {0}": "Notebook {0}",
  "Rename notebook": "Renommer le notebook",
  "Delete the notebook “{0}”?": "Supprimer le notebook « {0} » ?",
  "Imported notebook": "Notebook importé",
  "OK": "OK",
  "Delete notebook": "Supprimer le notebook",
  "Not a SequenceLab notebook file": "Ce n'est pas un fichier notebook SequenceLab",
  "A notebook can't be deleted when it's the only one": "Impossible de supprimer le seul notebook restant",
  "Export workspace…": "Exporter l'espace de travail…",
  "Import workspace…": "Importer l'espace de travail…",
  "Workspace exported": "Espace de travail exporté",
  "Not a SequenceLab workspace file": "Ce n'est pas un fichier d'espace de travail SequenceLab",
  "Import workspace": "Importer l'espace de travail",
  "Import this workspace? It replaces your current settings, query tabs, pins, saved filters, diagram layouts and notebooks, then reloads.": "Importer cet espace de travail ? Il remplace vos paramètres, onglets de requête, épingles, filtres enregistrés, dispositions de diagramme et notebooks actuels, puis recharge.",
  "SQL cell": "Cellule SQL",
  "Text cell": "Cellule texte",
  "Switch notebook": "Changer de notebook",
  "Export notebook": "Exporter le notebook",
  "Import notebook": "Importer le notebook",
  "SQL notebook": "Notebook SQL",
  "SQL Notebook (new rail tab): mix runnable SQL cells and markdown notes in one document, with each cell's results shown inline — create, rename, run-all and export notebooks":
    "Notebook SQL (nouvel onglet) : combinez des cellules SQL exécutables et des notes markdown dans un même document, avec le résultat de chaque cellule affiché en ligne — créez, renommez, exécutez tout et exportez des notebooks",
  "Export / import your workspace — settings, query tabs, pins, saved filters, diagram layouts and notebooks — as a single file (File menu)":
    "Exportez / importez votre espace de travail — paramètres, onglets de requête, épingles, filtres enregistrés, dispositions de diagramme et notebooks — en un seul fichier (menu Fichier)",
  "Duplicate notebook": "Dupliquer le notebook",
  "No cells yet.": "Aucune cellule pour l'instant.",
  "(empty text)": "(texte vide)",
  "(empty SQL)": "(SQL vide)",
  "No saved snippets yet.": "Aucun snippet enregistré pour l'instant.",
  "Insert into the focused SQL cell": "Insérer dans la cellule SQL active",
  "copy": "copie",
  "Notebook view": "Vue Notebook",
  "Outline": "Plan",
  "Save current SQL cell as a snippet": "Enregistrer la cellule SQL active comme snippet",
  "Click into a SQL cell first": "Cliquez d'abord dans une cellule SQL",
  "Focus a SQL cell with some SQL first": "Placez le curseur dans une cellule SQL contenant du SQL",
};
